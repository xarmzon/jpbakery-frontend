...
const Hero = () => {
  return (
    <header className="relative min-h-[70vh] w-full bg-image1 bg-cover bg-left md:bg-bottom">
      <span className="z-1 absolute inset-0 h-full w-full bg-gradient-to-t from-primary/40 to-secondary/30"></span>
      <div className="container relative z-[2] flex h-[60vh] items-center justify-center px-5 pt-20 md:justify-end xl:pt-24">
