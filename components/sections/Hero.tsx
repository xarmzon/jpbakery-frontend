...
const Hero = () => {
  ...
  return (
    <header className="relative min-h-[80vh] w-full bg-image1 bg-cover bg-left md:bg-bottom lg:min-h-[90vh]">
      <span className="z-1 absolute inset-0 h-full w-full bg-gradient-to-t from-primary/40 to-secondary/30"></span>
      <div className="container relative z-[2] flex h-[75vh] items-center justify-center px-5 pt-20 md:justify-end lg:h-[80vh] xl:pt-24">
