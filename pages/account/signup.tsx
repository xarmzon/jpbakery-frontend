...
const SignUpPage: NextPage = () => {
  ...
  return <AuthLayout title="Join Us">
    <div className="p-5 flex flex-col justify-center h-full w-full space-y-5">
      <h1 className="font-bold text-2xl text-slate-700 text-center">Join Us</h1>
      <div className="">
          ...
          <div className="text-center mb-5">
              ...
              <div className="mt-2">
                <p className="text-xs md:text-sm">
                  Or{" "}
                  <Button linkClassName='text-secondary hover:text-ascent-light' isLink href={ROUTES.ACCOUNT.LOGIN} text="Login Here"/>
